...
class CLIApp:
    ...
    def __init__(self, name: str = "bifrost", theme: Optional[Theme] = None) -> None:
        self.name = name
    ...
    def create_panel(self, content: str, title: str, border_style: str = "info") -> Panel:
...
class InteractiveCLI(CLIApp):
    ...
    def interactive_menu(self, options: Dict[str, str], title: str = "Select an option") -> str:
    ...
    def display_connection_status(self, protocol: str, host: str, port: int, 
                                 connected: bool) -> None:
